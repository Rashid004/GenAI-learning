...
# TODO: Can you explain me in hinglish after add Comments properly
...
answer_prompt = ChatPromptTemplate.from_messages(
    [
        (
            "system",
            "You are a helpful Javascript&React.js tutor. Answer ONLY using the provided refined bullets.\n"
...
res = app.invoke({
    "question": "Explain the DOM manuplation",
    "docs": [],
    "strips": [],
    "kept_strips": [],
    "refined_context": "",
